...
$VCFManagementServicesPassword = "VMware123!VMware123!"
$VCFManagementServicesRuntimeFQDN = "vsp-01a.site-a.vcf.lab"
$VCFManagementServicesFleetFQDN = "fleet-01a.site-a.vcf.lab"

# Backup Configuration
$daysToBackup = @("MON","TUE","WED","THU","FRI","SAT","SUN")
$startTime = "10:00Z" # Zula format (UTC)
$sftpServer = "linux.ad.home"
$sftpServerPort = "22"
$sftpServerUsername = "vcfbackup"
$sftpServerPassword = "VCFBackup"
$sftpServerBackupDirectory = "/home/vcfbackup/vcfbackup"
$sftpServerEncryptionPassword = "VMware123!VMware123!"
# Need to manually run ssh-keyscan -p $sftpServerPort $sftpServer 2>$null | Select-Object -First 1
$sftpServerHostKey = 'linux.ad.home ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBD3hNqFabFn966fOSJ57sbhkiJnRGxNQ45b6G/kn+tNA4YkR30Bvn6HX011ol6ITFrki/7VLaMC7L7ZFMOLVwWc=
'

$ValidateOnly = $false # change to false to deploy
